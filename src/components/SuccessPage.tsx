...
export function SuccessPage({ customerName, pdfFilename, onNewProposal }: SuccessPageProps) {
  const downloadPDF = () => {
    if (pdfFilename) {
          ...
          <div className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Sua proposta foi gerada e enviada com sucesso. Nossa equipe de vendas 
                entrará em contato em breve para dar andamento ao processo.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-green-900">PDF Gerado</p>
                    <p className="text-sm text-green-700">Proposta criada com sucesso</p>
                  </div>
                </div>
              </div>
            ...
            {pdfFilename && (
              <div className="bg-[#FFC629]/10 border border-[#FFC629]/30 rounded-xl p-6 mb-8">
                <div className="text-center">
                  <Download className="mx-auto h-12 w-12 text-[#1A1A1A] mb-4" />
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    📄 Sua Proposta está Pronta
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Baixe uma cópia da sua proposta em PDF para seus registros
                  </p>
                  <button
                    onClick={downloadPDF}
