  ...
  return (
    <div className="relative bg-gradient-to-br from-[#FFC629] to-[#FFD93D] p-12 md:p-6 text-center overflow-hidden rounded-t-2xl">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='50' height='50' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23000000' fill-opacity='0.02'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
